...
{
    public static SequentialGuidType DefaultCreateGuidType = SequentialGuidType.SequentialAsString;
    private static readonly RandomNumberGenerator _randomNumberGenerator = RandomNumberGenerator.Create();

    public SequentialGuidGenerator()
    { }

    public static Guid NewGuid(SequentialGuidType? guidType = null)
    {
        guidType ??= DefaultCreateGuidType;
    ...
    public Guid Create()
    {
        return this.Create(DefaultCreateGuidType);
    }
